...
description = "spring-setting-memory"
...
mavenPublishing {
  ...
  pom {
    name.set("spring-setting-memory")
    description.set("Spring Setting Memory provides a Caffeine-based in-memory implementation for the SettingRepository.")
